...
INSERT INTO users (username, password, first_name, last_name, email) VALUES ('a', '1', 'a1', 'a2', 'a@gmail.com') RETURNING user_id;
INSERT INTO users (username, password, first_name, last_name, email) VALUES ('b', '2', 'b1', 'b2', 'b@gmail.com') RETURNING user_id;
INSERT INTO users (username, password, first_name, last_name, email) VALUES ('c', '3', 'c1', 'c2', 'c@gmail.com') RETURNING user_id;